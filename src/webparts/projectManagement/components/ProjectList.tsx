    ...
    const fetchItems = async (): Promise<void> => {
      ...
      try {
        ...
        const formatted = data.map<Project>((item) => ({
          ...
          Sector: item.Sector,
          ProjectDescription:
            item.ProjectDescription || "No Project Description",
        ...
        setSelectedProjectId(
          ProjectSelectionService.getSelectedProject()?.id || null
        );
      } catch (err) {
          ...
          <Table style={{ tableLayout: "auto" }} sortable>
            <TableHeader className={styles.tableHeader}>
              <TableRow>
                ...
                <TableHeaderCell
                  style={{ minWidth: "110px", maxWidth: "250px" }}
                >
                  Project Manager
                </TableHeaderCell>
                <TableHeaderCell
